...
class VendorResource extends JsonResource
{
    public function toArray(Request $request): array
    {
        return [
            ...
            'cover_image' => $this->cover_image ? (filter_var($this->cover_image, FILTER_VALIDATE_URL) ? $this->cover_image : url('storage/' . $this->cover_image)) : null,
            'gallery' => $this->gallery ? collect($this->gallery)->map(fn($img) => filter_var($img, FILTER_VALIDATE_URL) ? $img : url('storage/' . $img)) : [],
